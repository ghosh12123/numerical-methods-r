...
- Break the work into measurable steps: "First fix X. [Test]. Now fix Y. [Test]. Now fix Z. [test]"
...
- Claude could generate mathematically plausible formulas, but could not guarantee they were correct for my specific implementation
